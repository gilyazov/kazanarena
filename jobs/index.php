...
<div class="w48 right"> 
  <div class="rightvacancyform "> 
    ...
    <p>Не нашли подходящей вакансии? Пришлите свое резюме, и мы свяжемся с вами, чтобы обсудить возможности трудоустройства.</p>
   <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"RESIZE_IMAGES" => "N",
		"PROPERTY_CODES" => array(0=>"NAME",1=>"105",2=>"106",3=>"107",),
		"PROPERTY_CODES_REQUIRED" => array(0=>"NAME",1=>"106",),
		"GROUPS" => array(0=>"2",),
		"STATUS" => "ANY",
...
$(document).ready(function () {
   ...
   {rules: {
         PROPERTY_FILE_103_0: {
            extension: "docx|doc|rtf|pdf|txt"
         }
      },
      messages: {
         PROPERTY_FILE_103_0: {
            extension: "Только .docx, .doc, .rtf, .txt, .pdf."
         }
	  }
   }
